    ...
    <section>
      <div className="HeroContainer">
        <div className="Intro-Section">
          <div className="flex flex-row items-center mb-2 rounded-4xl bg-amber-50 w-60 pl-3 pr-3 pt-0.5 pb-0.5">
            {/* Icon goes here */}
          ...
          <div>
            <div>
              <p className="text-black font-bold text-[55px]">
                Unleash Your Inner
              </p>
              <h1 className="text-amber-400 font-bold underline mb-6">
                Dog Expert
              </h1>
              <h3 className="text-[#8a7c60] text-[20px] font-medium lg:w-120">
        ...
        <div className="DogPhoto-Section">
          <div className="w-full md:min-w-90 md:max-w-120 flex justify-center lg:justify-end relative">
